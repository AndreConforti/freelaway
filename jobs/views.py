...
def encontrar_jobs(request):
    if request.method == "GET":
        ...
        ##TODO: verificar a possibilidade de melhorar esses filtros
...
def perfil(request):
    if request.method == "GET":
        ...
        ## Faça um filtro no banco de dados para encontrar um usuário, mas exclua o usuário que está logado. Ou seja, faça a busca para encontrar se houver outro além do que ja existe. Pois quero fazer alterações no perfil já existente.
